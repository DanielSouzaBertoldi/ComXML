...
/**
 * This layout enables you to create a custom top bar
 * utilizing the same scroll behaviors as Material top bars
 */
@ExperimentalMaterial3Api
@Composable
fun CustomTopBarLayout(
    modifier: Modifier = Modifier,
    colors: FlexibleTopBarColors = CustomTopBarLayoutDefaults.colors(),
...
object CustomTopBarLayoutDefaults {

    @Composable
    fun colors(
        containerColor: Color = MaterialTheme.colorScheme.primary,
        scrolledContainerColor: Color = MaterialTheme.colorScheme.surfaceColorAtElevation(2.dp),
